/* PTA適正化推進委員会 — site.js v51 safe loader */
(function(){
  function runBaseInitializers(){
  ...
  function runLocalFixes(){fixParentPdfButtons();addTopRoleCards();}
  var s=document.createElement('script');
  s.src='/js/site-v48-original.js?v=48';
  s.onload=function(){
    if(document.readyState==='loading'){
      document.addEventListener('DOMContentLoaded',function(){runBaseInitializers();runLocalFixes();},{once:true});
    }else{
      runBaseInitializers();runLocalFixes();
    }
  };
  s.onerror=function(){console.error('base site script failed to load');runLocalFixes();};
