...
(function(){
  ...
  function rebuildHomeReadingSection(){
    ...
    var figureHtml=Array.from(s.querySelectorAll('.lc-fig,.sep-fig')).map(function(el){return el.outerHTML;}).join('');
