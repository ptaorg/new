(() => {
  ...
  const ROLE_CONFIG = {
    ...
    school: {
      ...
      questions: ['学校がPTA文書を配布・回収している実態はありますか。', 'PTA会費を学校徴収金に含めている学校はありますか。', '学校保有の個人情報をPTAへ提供している実態はありますか。', 'PTA名簿作成に学校名簿・クラス名簿が使われていませんか。', '教職員がPTA固有事務を勤務時間内に行っていませんか。', '学校連絡アプリをPTA連絡に利用していませんか。', '教育委員会として学校向けのPTA運営適正化通知はありますか。'],
      links: [
  ...
  const AUDIT_DB = {
    ...
    officer: [
      ...
      makeCheck({ cat: '学校名簿', axis: 'privacy', q: '学校名簿、クラス名簿、児童名簿、保護者連絡先、地区情報を、PTA会員管理に利用していませんか。', riskOn: 'no', severity: 3, risk: '学校保有個人情報のPTA利用', advice: '学校名簿やクラス名簿を会員管理に使っている場合、情報の取得元と本人同意を確認する必要があります。' }),
      makeCheck({ cat: '非会員把握', axis: 'privacy', q: '非会員を把握するために、PTA会員名簿と学校保有の全児童・全保護者情報を突合していませんか。', riskOn: 'no', severity: 3, risk: '非会員把握のための学校情報突合', advice: '非会員を割り出して個別管理する方向ではなく、児童への対応をPTA加入状況と切り離す方向で見直してください。' }),
      ...
      makeCheck({ cat: '学校職員事務', axis: 'personnel', q: 'PTA文書の配布、回収、集計、名簿作成、会費処理を、担任・教頭・事務職員など学校職員に依頼していませんか。', riskOn: 'no', severity: 3, risk: '教職員のPTA事務従事', advice: 'PTA固有事務を学校職員が担う運用は、学校とPTAの分離を不明確にします。PTAが自ら処理する体制へ移行してください。' }),
      makeCheck({ cat: '学校連絡ツール', axis: 'personnel', q: 'PTA連絡を、学校アプリ・学校メール・学校一斉配信システムで行っていませんか。', riskOn: 'no', severity: 2, risk: '学校連絡ツールのPTA利用', advice: '学校連絡ツールでPTA連絡を行う場合、学校手続とPTA活動の境界が曖昧になります。PTA独自の連絡手段を検討してください。' }),
      makeCheck({ cat: '役員選出', axis: 'governance', q: '役員・委員選出を、くじ引き、未提出者対象、電話に出なければ承諾扱いなどで行っていませんか。', riskOn: 'no', severity: 2, risk: '役員選出の強制化', advice: '役員選出は希望制、活動棚卸し、参加できる人が参加する形へ見直す必要があります。' }),
      ...
      makeCheck({ cat: '児童の取扱い', axis: 'facilities', q: '児童への対応、行事参加、配布物、記念品、安全活動等を、PTA加入状況と結び付けていませんか。', riskOn: 'no', severity: 3, risk: '非加入・退会を児童の取扱いと結び付ける運用', advice: '児童への対応や学校教育上の取扱いは、PTA加入状況と切り離す方向で整理してください。' }),
      makeCheck({ cat: '学校管理職', axis: 'personnel', q: '校長・教頭など学校管理職が、PTAの主要役職や会計・名簿・役員選出に関与していませんか。', riskOn: 'no', severity: 2, risk: '校長・教頭等のPTA主要役職関与', advice: '学校管理職がPTAの主要役職や会計・名簿・役員選出に関与している場合、学校とPTAの分離が不明確になります。' }),
    ...
    school: [
      ...
      makeCheck({ cat: '制度処理', axis: 'personnel', q: 'PTA固有事務を、校務、職専免、兼職承認等の名目で学校側が恒常的に処理していませんか。', riskOn: 'no', severity: 2, risk: 'PTA固有事務の学校処理', advice: '形式上の処理根拠があるかではなく、PTA固有事務を学校から分離できているかを確認してください。' }),
      makeCheck({ cat: '個人情報提供', axis: 'privacy', q: '学校保有の児童・保護者情報を、PTA会員管理、役員選出、地区班、登校班、当番表、協力金依頼等に利用・提供していませんか。', riskOn: 'no', severity: 3, risk: '学校保有個人情報のPTA利用', advice: '公立学校が保有する個人情報をPTA用途へ使う場面では、個人情報保護法第69条の目的外利用・提供の問題として確認が必要です。', links: [{ label: '個人情報', url: '../privacy.html' }] }),
      makeCheck({ cat: '学校名簿', axis: 'privacy', q: 'PTAが学校名簿、クラス名簿、保護者連絡先、地区情報を利用していませんか。', riskOn: 'no', severity: 3, risk: '学校保有個人情報のPTA利用', advice: 'PTAが学校名簿やクラス名簿を利用している場合、提供元、利用目的、本人同意、提供記録を確認してください。' }),
      ...
      makeCheck({ cat: '学校手続混在', axis: 'membership', q: '入学説明会、入学式、年度初めの学校手続の中に、PTA加入案内、入会申込、個人情報同意、役員希望調査を混在させていませんか。', riskOn: 'no', severity: 2, risk: '学校手続とPTA手続の混在', advice: '学校手続の中にPTA手続が混在している場合、任意性が保護者へ伝わっているか確認してください。' }),
      makeCheck({ cat: '施設・印刷', axis: 'facilities', q: '学校施設、印刷機、児童経由配布、担任経由回収を、PTAに無条件で利用させていませんか。', riskOn: 'no', severity: 2, risk: '学校施設・印刷機・児童経由配布の利用', advice: '施設、印刷機、児童経由配布、担任回収には、利用条件、費用負担、公平性、学校教育との区分を確認する必要があります。', links: [{ label: '施設利用', url: '../facilities.html' }] }),
      makeCheck({ cat: '児童の取扱い', axis: 'facilities', q: 'PTA加入状況を、児童への対応、配布物、行事参加、登下校、安全活動、記念品等の取扱いと結び付けていませんか。', riskOn: 'no', severity: 3, risk: '非加入・退会を児童の取扱いと結び付ける運用', advice: '児童への対応や学校教育上の取扱いは、PTA加入状況と切り離して整理してください。' }),
      makeCheck({ cat: '非会員把握', axis: 'privacy', q: '非会員への協力金依頼、記念品除外、行事対象者整理等のために、PTA会員情報と学校保有の児童・保護者情報を突合していませんか。', riskOn: 'no', severity: 3, risk: '非会員把握のための学校情報突合', advice: '非会員を割り出して個別対応する方向ではなく、児童に関わる取扱いをPTA加入状況と切り離す方向で整理してください。' }),
